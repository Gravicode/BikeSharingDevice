...
namespace GPS
{
    ...
    /// </summary>
    public class SimpleSerial : System.IO.Ports.SerialPort
    {
        ...
        public SimpleSerial(string portName, int baudRate, System.IO.Ports.Parity parity, int dataBits)
        ...
        public SimpleSerial(string portName, int baudRate)
        ...
        /// </returns>
        public string[] Deserialize(string delimiter = "\r\n")
        {
            string receivedData = string.Concat(this._Remainder, this.ReadExisting());   // attach the previous remainder to the new data
            return SplitString(receivedData, out this._Remainder, delimiter);  // return itemized messages and store remainder for next pass
        }
